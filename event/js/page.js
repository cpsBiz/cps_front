...
const $sub5ToolTipBoxs = document.querySelectorAll('.sub-5 .point-info .tool-tip-box');

// sub-5-1
const $sub5_1 = document.querySelector('.sub-5-1');
const $sub5_1ListWrapBox = document.querySelector('.sub-5-1 .list-wrap-box');
const $sub5_1ListWrapBoxFirstList = document.querySelector('.sub-5-1 .list-wrap-box .first-list');
const $sub5_1ListWrapBoxListWrap = document.querySelector('.sub-5-1 .list-wrap-box .list-wrap');
const $sub5_1ListWrapBoxListWrapLists = document.querySelectorAll('.sub-5-1 .list-wrap-box .list-wrap .list');
